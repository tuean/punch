...
<div class="divide-y divide-gray-200 dark:divide-gray-700">
	...
	<div class="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
		<div class="flex flex-col items-center py-6">
			<img src={config.repoLogo} alt="logo" class="h-64 w-64" />
...
<!--			this website is clone by <a href="https://github.com/akiarostami/sveltekit-tailwind-blog-starter">sveltekit-tailwind-blog-starter</a>.-->
<!--			<br>-->
