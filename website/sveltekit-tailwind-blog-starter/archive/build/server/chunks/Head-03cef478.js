import { c as create_ssr_component, e as escape, a as add_attribute } from './index-32db5bef.js';
import { c as config } from './config-85e7a33b.js';

const Head = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { title = "Official Website" } = $$props;
  ...
  if ($$props.img === void 0 && $$bindings.img && img !== void 0)
    $$bindings.img(img);
  return `${$$result.head += `<!-- HEAD_svelte-gjn0ej_START -->${$$result.title = `<title>${escape(title)} | ${escape(config.title)}</title>`, ""}<meta name="description"${add_attribute("content", description, 0)}><meta name="author"${add_attribute("content", author, 0)}><meta property="og:url"${add_attribute("content", url, 0)}><meta property="og:type" content="website"><meta property="og:title"${add_attribute("content", title, 0)}><meta property="og:description"${add_attribute("content", description, 0)}><meta property="og:image"${add_attribute("content", img, 0)}><meta name="twitter:card" content="summary_large_image"><meta property="twitter:domain"${add_attribute("content", domain, 0)}><meta property="twitter:url"${add_attribute("content", url, 0)}><meta name="twitter:title"${add_attribute("content", title, 0)}><meta name="twitter:description"${add_attribute("content", description, 0)}><meta name="twitter:image"${add_attribute("content", img, 0)}><!-- HEAD_svelte-gjn0ej_END -->`, ""}`;
});

export { Head as H };
//# sourceMappingURL=Head-03cef478.js.map
