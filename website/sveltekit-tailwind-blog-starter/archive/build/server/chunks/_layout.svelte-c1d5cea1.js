import { c as create_ssr_component, v as validate_component, a as add_attribute, e as escape, b as each } from './index-32db5bef.js';
import { c as config, n as navLinks } from './config-85e7a33b.js';
import { S as SocialIcon } from './SocialIcon-d02abf90.js';
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="flex items-center justify-between py-10"><div><a href="/"${add_attribute("aria-label", config.headerTitle, 0)}><div class="flex items-center justify-between"><div class="mr-3"><img src="/tuean.jpg" alt="Logo" class="h-10 w-auto"></div>
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer><div class="mt-16 flex flex-col items-center border-t pt-6 gap-2"><div class="mb-3 flex space-x-2">${validate_component(SocialIcon, "SocialIcon").$$render(
    ...
    {}
		...
		<div class="mb-4 flex space-x-2 text-sm text-gray-500 dark:text-gray-400"><a href="https://beian.miit.gov.cn">${escape(config.website)}</a> <a href="/">${escape(config.title)}</a>   •   © ${escape(year)}
...
//# sourceMappingURL=_layout.svelte-c1d5cea1.js.map
